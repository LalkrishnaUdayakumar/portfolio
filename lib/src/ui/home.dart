  ...
  List<Widget> _buildActions() {
    return <Widget>[
      ...
      MaterialButton(
        ...
        onPressed: () {
          html.window.open("mailto:lalkrishnaudayakumar40@gmail.com", "Email");
        },
      ),
    ];
  }
...
//        _buildNavigationArrows(),
  ...
  final workingExperienceList = [
    ...
    Education(
      'March 2019',
      'March 2022',
      'IHRD College of Applied Science, Dhanuvachapuram, Kerala University',
  ...
  Widget _buildEducationSummary() {
    return Text(
      "Software Engineer at Algolsoft (March 2025 - Present) with hands-on experience "
      "in developing and maintaining enterprise solutions using Java, Spring Boot, and Flutter. "
      "Skilled in designing RESTful APIs, microservices, and full-stack applications. "
      "Experienced in DevOps practices using ArgoCD, GitLab, Bitbucket, and Docker. "
      "Worked on ESB projects for global telecom clients and contributed to Apache ServiceMix integrations. "
      "Actively involved in code reviews, mentoring, and production support.",
      style: TextStyles.body,
    );
  }
    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            html.window.open(
                "https://www.linkedin.com/in/lalkrishna-udayakumar-software-developer-410341243/",
                "LinkedIn");
          },
          child: Image.network(
            Assets.linkedin,
        ...
        GestureDetector(
          onTap: () {
            html.window
                .open("mailto:lalkrishnaudayakumar40@gmail.com", "Email");
          },
          child: Image.network(
            Assets.mail,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window
                .open("https://github.com/LalkrishnaUdayakumar", "Github");
          },
          child: Image.network(
            Assets.github,
            color: Color(0xFF45405B),
        ...
        GestureDetector(
          onTap: () {
            html.window
                .open("https://www.instagram.com/lal.the.theic/", "instagram");
          },
          child: Image.network(
            Assets.twitter,
            color: Color(0xFF45405B),
